# The test suite needs this as a list rather than a bunch of definitions so that we can
# append _test to it.

dyninst_add_interface_library(dynCapArchDef "Interface target for capability defines")

set(CAP_DEFINES cap_dynamic_heap cap_liveness cap_threads)
...
# this should probably be removed and instead one should "link" to Dyninst::dynCapArchDef
# target, e.g.:
#
